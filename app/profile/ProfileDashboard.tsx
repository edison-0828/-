...
type ListingItem = { id: string; title: string; city: string; district: string; community: string; monthlyRentCents: number; availableFrom: string; status: string; createdAt: string };
type FavoriteItem = { id: string; title: string; city: string; district: string; community: string; monthlyRentCents: number; availableFrom: string; savedAt: string };
